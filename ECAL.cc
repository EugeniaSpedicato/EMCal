...
ECAL::ECAL(double nbinsx, 
    ...
    EnRad_3 = new TProfile("Step3", "Radial Profile Step 3", 20, 0, 4, 0, 5);
    EnRad_3->SetErrorOption("S");
    EnRad_6 = new TProfile("Step6", "Radial Profile Step 6", 20, 0, 4, 0, 5);
    EnRad_6->SetErrorOption("S");
    EnRad_13 = new TProfile("Step13", "Radial Profile Step 13", 20, 0, 4, 0, 5);
    EnRad_13->SetErrorOption("S");
    EnRad_20 = new TProfile("Step20", "Radial Profile Step 20", 20, 0, 4, 0, 5);
...
void ECAL::Fill_(TH1F* &Rad1, TH1F* &Rad2, TH1F* &Rad3, TH1F* &Rad4)
{
